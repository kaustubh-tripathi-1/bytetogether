                ...
                awarenessTimerRef.current = setTimeout(() => {
                    ...
                    requestIdleCallback(() => {
                        ...
                        [...added, ...updated].forEach((clientId) => {
                            ...
                            console.log(
                                `client id for this client - ${clientId} and state - ${state}`
                            );

                            if (state && state.user && state.selection) {
                                ...
                                if (selection.anchor !== selection.head) {
                                    ...
                                    const headPos = model.getPositionAt(end);
                            ...
                            const cursorPosition =
                                model.getPositionAt(cursorOffset); */
                                const absoluteHead =
                                    createAbsolutePositionFromRelativePosition(
                                        selection.head,
                                        yDoc
                                ...
                                if (!absoluteHead) return; // Prevents null crash
                                ...
                                if (
                                    ...
                                    const codeEditorSection =
                                        closestSectionRef.current; // Or pass a ref to the section
                                    ...
                                    tooltipElement.style.top = `${targetPixelPosition.top - tooltipElement.offsetHeight - 5}px`; // 5px above cursor
